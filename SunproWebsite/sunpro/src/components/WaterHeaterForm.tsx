...
import { Unit } from "./waterHeater";
import "./waterHeaterForm.css";
...
const WaterHeaterForm: React.FC<HeaterFormProps> = ({ selected, onClose }) => {
  ...
  return (
    <div className="heater-form" id="heater-view">
      <div className="heater-det" id="heater-det">
        <h3>

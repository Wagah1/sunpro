...
import { Panel } from "./solar-panels";
import "./shopForm.css";
...
const ShopForm: React.FC<ShopFormProps> = ({ selectedPanel, onClose }) => {
  ...
  return (
    <div className="shop-form">
      <div className="panel-det" id="panel-det">
        <h3>
          Panel details:
          <br /> {selectedPanel.name} @{" "}
          <span className="bold"> Ksh {selectedPanel.price}/-</span>
        </h3>
        <p>
        ...
        <div className="customer">
          ...
          <div className="total">
            <p>
              Total cost:{" "}
              <span className="bold">
                Ksh {selectedPanel.price * orderQuantity}/-{" "}
              </span>
            </p>
          </div>

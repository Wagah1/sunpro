...
import { Unit } from "./sunking";
import "./sunkingForm.css";

interface SunkingFormProps {
  selected: Unit;
  onClose: () => void;
}

const SunkingForm: React.FC<SunkingFormProps> = ({ selected, onClose }) => {
  ...
  return (
    <div className="sunking-form" id="sunking-view">
      <div className="sunking-det" id="sunking-det">
        <h3>
          Sunking Package details:
          <br /> {selected.name} @{" "}

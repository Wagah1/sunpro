...
const BatteryForm: React.FC<BatteryFormProps> = ({ selected, onClose }) => {
  ...
  return (
    <div className="battery-form" id="battery-view">
      <div className="battery-det" id="battery-det">
        <h3>
          Battery details:
          <br /> {selected.name} @{" "}
